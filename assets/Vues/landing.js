		...
		window.vm = new Vue({
				...
				template: [
				    ...
				    '<div class="landing-img-box">',
				      '<img class="img-responsive" src="img/zaym.jpg"/>',
				    '</div>',
					  ...
					  '<div class="profit">',
					    ...
					    '<div class="landing-img-box">',
					      '<img class="img-responsive" src="img/preimushestva.jpg"/>',
					    '</div>',
					  '</div>',
					  '<hr/>',
					      ...
					      '<div class="col-md-12">',
					        '<div class="panel-body">',
					          ...
					          '<div class="form-group">',
					            ...
					            '<div class="col-md-9">',
					              '<input type="text" name="sum" class="form-control ignore"/>',
					            '</div>',
					          '</div>',
					          '<div class="form-group">',
					            '<div class="col-md-3"></div>',
					            '<div class="radio-flex col-md-9">',
					              '<label class="radio-inline">',
					                '<input type="radio" name="fz" checked="checked"/><span>44-ФЗ</span>',
					              '</label>',
					              '<label class="radio-inline">',
					                '<input type="radio" name="fz"/><span>223-ФЗ</span>',
					              '</label>',
					            '</div>',
					          '</div>',
					          '<div class="form-group">',
					            ...
					            '<div class="col-md-9">',
					              '<input type="text" value="" name="procedurenumber" class="form-control ignore"/>',
